...
namespace Huertos_Autosustentables.Data.Migrations
{
    ...
    [Migration("20200823233722_ImgRegionTipoCultivo")]
    partial class ImgRegionTipoCultivo
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Huertos_Autosustentables.Models.Clima", b =>
                {
            ...
            modelBuilder.Entity("Huertos_Autosustentables.Models.Cultivo", b =>
                {
            ...
            modelBuilder.Entity("Huertos_Autosustentables.Models.DetalleUsersCultivo", b =>
                {
            ...
            modelBuilder.Entity("Huertos_Autosustentables.Models.Region", b =>
                {
                    b.Property<int>("IdRegiones")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Huertos_Autosustentables.Models.TipoCultivo", b =>
                {
                    b.Property<int>("IdTipoCultivo")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Huertos_Autosustentables.Models.Cultivo", b =>
                {
                    b.HasOne("Huertos_Autosustentables.Models.Region", "FK_")
                        .WithMany("Cultivos")
                        .HasForeignKey("FK_IdRegiones");

                    b.HasOne("Huertos_Autosustentables.Models.TipoCultivo", "Fk_")
                        .WithMany("Cultivos")
            ...
            modelBuilder.Entity("Huertos_Autosustentables.Models.DetalleUsersCultivo", b =>
                {
                    b.HasOne("Huertos_Autosustentables.Models.Cultivo", "FK_")
                        .WithMany("Detalles")
            ...
            modelBuilder.Entity("Huertos_Autosustentables.Models.Region", b =>
                {
                    b.HasOne("Huertos_Autosustentables.Models.Clima", "FK_")
                        .WithMany("Regiones")
